angular.module("app",["ngResource","ngMessages","ngAnimate","ui.router","satellizer","toastr"]).config(["$authProvider","$stateProvider","$urlRouterProvider",function(e,t,l){function r(e,t){var l=e.defer();return t.isAuthenticated()?l.reject():l.resolve(),l.promise}function o(e,t,l){var r=e.defer();return l.isAuthenticated()?r.resolve():t.path("/login"),r.promise}r.$inject=["$q","$auth"],o.$inject=["$q","$location","$auth"],e.facebook({clientId:"1670205403245071"}),e.google({clientId:"696255640250-ha91c7enlsravhptab5c63punfunlh8u.apps.googleusercontent.com"}),l.otherwise("/"),t.state("home",{url:"/",controller:"homeCtrl",templateUrl:"partials/home.html"}).state("login",{url:"/login",templateUrl:"partials/login.html",controller:"loginCtrl",resolve:{skipIfLoggedIn:r}}).state("signup",{url:"/signup",templateUrl:"partials/signup.html",controller:"signupCtrl",resolve:{skipIfLoggedIn:r}}).state("logout",{url:"/logout",template:null,controller:"logoutCtrl"}).state("profile",{url:"/profile",templateUrl:"partials/profile.html",controller:"profileCtrl",resolve:{loginRequired:o}})}]);
